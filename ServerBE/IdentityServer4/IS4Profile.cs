...
{
    public class IS4Profile : IProfileService
    {
        private readonly ILogger<IS4Profile> _logger;
        private readonly UserManager<User> _userManager;

        public IS4Profile(UserManager<User> userManager,
            ILogger<IS4Profile> logger)
        {
            _logger = logger;
